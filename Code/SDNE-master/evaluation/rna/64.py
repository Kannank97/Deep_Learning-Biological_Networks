...
X = test.iloc[0:1000 , 0:64];
#print(X)
Y = test.iloc[0: 1000, -1];
#print(Y) 
X_test = test.iloc[1001: 1474 , 0:64];
Y_test = test.iloc[1001:1474, -1];
...
#print(model.predict(test.iloc[514: 594743, 0:256 ]))
...
#print(modelrf.predict(test.iloc[514: 594743, 0:256 ]))
...
#print(modelk.predict(test.iloc[514: 594743, 0:256]))
...
#print(modelgn.predict(test.iloc[514: 594743, 0:256]))
