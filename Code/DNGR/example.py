...
with open('/home/user/Work1/DNGR/wine.edgelist','wb') as f:
	nx.write_weighted_edgelist(data_edge, f)

subprocess.call('/home/user/Work1/DNGR/DNGR.py --graph_type '+'undirected'+' --input '+'wine.edgelist'+' --output '+'representation',shell=True)
